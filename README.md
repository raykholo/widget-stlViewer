  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetStlViewer) {
        ...
        console.log("Widget / Template just got loaded.", myObjWidgetStlViewer);
