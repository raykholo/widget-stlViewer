...
cpdefine("inline:com-chilipeppr-widget-stlViewer", ["chilipeppr_ready", "Clipper", "jqueryuiWidget", "STLLoader"], function(cp, clipper, jqui, stlR) {
    return {
        ...
        init: function() {
            ...
            console.log("our STL obj is alive: ", MeshesJS); //ThreeDxf);
            var stlreader = new MeshesJS.STLLoader();
            console.log("STL Reader:", stlreader);
            this.stlReader = stlreader;
1
            ...
            this.dropArea.bind({
                ...
                drop: function(e) {
                    var looksLikeBinary = function(reader) {
                        ...
                        console.log('Binary Count: ', predictedSize);
                        console.log('Reader Count: ', reader.getSize())
